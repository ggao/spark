...
class ClientBaseSuite extends FunSuite with Matchers {
  ...
  object Fixtures {
    ...
    val knownDefMRAppCP: Seq[String] =
      getFieldValue2[String, Array[String], Seq[String]](classOf[MRJobConfig],
  ...
  private class DummyClient(
    ...
    override def runApp(f: (YarnResourceCapacity) => ClientArguments): (ApplicationId, ClientArguments) = ???
